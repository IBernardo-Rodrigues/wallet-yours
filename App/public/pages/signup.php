...
<head>
  ...
  <title>WalletYours - Cadastrar</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
  <link rel="stylesheet" href="App/public/assets/css/default.css">
  <link rel="stylesheet" href="App/public/assets/css/signup.css">
</head>
<body>

  <main class="login bg-light rounded p-3">
    <h1 class="text-center">Cadastrar</h1>
    <form method="POST" action="App/processData/signup/processSignUp.php" target="_self">
      <div class="mb-3">
        <label for="" class="form-label">Nome *</label>
        <input type="text" class="input-name form-control shadow-none" name="username" placeholder="Ex: João Silva">
    ...
    <div class="text-center mt-2 mb-1">
      <a href="signin" target="_self" class="">
  ...
  <script type="module" src="App/public/assets/js/signup.js"></script>
</body>
</html>
